...
SCORE_SOURCE_IN_GAME = "in_game"
SCORE_SOURCES = frozenset({SCORE_SOURCE_SEED, SCORE_SOURCE_SUBMISSION, SCORE_SOURCE_IN_GAME})
PLAYER_SCORE_SOURCES = frozenset({SCORE_SOURCE_SUBMISSION, SCORE_SOURCE_IN_GAME})
